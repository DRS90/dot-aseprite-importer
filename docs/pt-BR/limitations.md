...
- A grade é 3x3, com nomes de direção fixos e a célula central ignorada, ou a célula única de
  `grid/directions` em `none`. Outras grades, como 1x4 ou 4x4, não têm suporte.
