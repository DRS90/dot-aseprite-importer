...
2. Select the file in the FileSystem dock and open the **Import** dock. `grid/cell_size` at `(0, 0)`
   ...
   **Import As: Dot Aseprite SpriteFrames**. A sprite that faces nowhere, like an effect or
   ...
   is better off with *Import As: Dot Aseprite Texture*, described in
...
*Import As: Dot Aseprite Texture* and drawn by an ordinary Sprite2D, and `examples/tileset.aseprite`,
