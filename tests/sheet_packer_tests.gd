...
const SheetPacker := preload("res://addons/dot_aseprite_importer/sheet_packer.gd")
...
func _test_builder_skips_invisible(invisible: Image) -> void:
	var strips_dir := OS.get_cache_dir().path_join("dot_aseprite_importer_tests/invisible")
